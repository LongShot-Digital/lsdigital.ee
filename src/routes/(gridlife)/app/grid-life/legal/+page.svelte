...
<div class="legal">
	...
	<section class="legal-hero">
		<h1>Legal</h1>
		<p>Everything you need to know about how Grid Life handles your data and the terms of use.</p>
	</section>
...
<style>
	...
	.card-icon {
		...
		height: 48px;
		border-radius: 14px;
		background: linear-gradient(135deg, rgba(232, 168, 62, 0.12), rgba(232, 168, 62, 0.06));
		display: flex;
		align-items: center;
